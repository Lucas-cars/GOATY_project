...
--
-- Host: 127.0.0.1    Database: goatybd
-- ------------------------------------------------------
...
CREATE TABLE `movimiento_stock` (
  ...
  KEY `fk_movimiento_producto_idx` (`id_producto`),
  KEY `fk_movimiento_usuario_idx` (`id_usuario`),
  CONSTRAINT `fk_movimiento_producto` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id_producto`) ON UPDATE CASCADE,
...
-- Dump completed on 2025-09-05 14:51:19
